...
const DashPosts = () => {
  ...
  return (
    <div className="table-auto overflow-x-scroll md:mx-auto p-3 scrollbar lg:scrollbar-none scrollbar-track-stone-100 scrollbar-thumb-stone-300 dark:scrollbar-track-stone-800 dark:scrollbar-thumb-stone-500">
